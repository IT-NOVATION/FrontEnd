                ...
                {isVisible && (
                    ...
                    >
                        ...
                        <Block.RowBox>
                            {isSearchClick && (
                                <>
                                    <Block.ColumnBox width="100%" height="200px" bgColor="white" alignItems="center">
                                        <Block.RowBox width="900px" height="62px" bgColor="white">
                                            <Block.RowBox
                                                width="112px"
                                                bgColor="white"
                                                justifyContent="space-evenly"
                                        ...
                                        <Block.Bar width="900px" height="1px" bgColor="black" />
                                        ...
                                        <Block.RowBox
                                            ...
                                            justifyContent="center"
                                        >
                                            <Block.RowBox width="120px" bgColor="white" justifyContent="center">
                                                고라니
                                            </Block.RowBox>
                                            <Block.RowBox width="450px" bgColor="white">
                                                결과
                                            </Block.RowBox>
                                        </Block.RowBox>
                                    </Block.ColumnBox>

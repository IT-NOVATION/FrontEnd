...
export default function NavigationBar() {
    const { loginState, userId, nickname, profileImg } = useRecoilValue(loginStateAtom);
    ...
    const goToEntireMovie = async () => {
        navigate("/entireMovie");
    };
                    ...
                    >
                        <Block.RowBox justifyContent="space-between">
                            <Block.RowBox width="426px" justifyContent="space-between" alignItems="center">
                                ...
                                <Text.Title3 onClick={goToEntireMovie} color={textColor} pointer>
                                    영화
                                </Text.Title3>
                            ...
                            <Block.RowBox width="228px" justifyContent="flex-end" alignItems="center">
                                {pathname !== "/search-result" && (
                                    <S.Icons
                                        alt="close"
                                        src={isSearchClick ? "/icons/close.svg" : `/icons/search_dark.svg`}
                                ...
                                {loginState ? (
                                    <>
                                        ...
                                        >
                                            ...
                                            <ProfileImg
                                                img={profileImg ? profileImg : "/images/default_profile.png "}
                                                size="31px"
                                            />
                                        </Block.RowBox>
                                    </>

        ...
        <Block.FormWrapper>
            <Block.Form>
                ...
                <Block.FormInputSection margin="0 0 8px 0">
                    <Input.CheckBoxInput id="agreeAll" onChange={toggleAgreeAll} type="checkbox" checked={agreeAll} />
                    <label htmlFor="agreeAll">
                        <Text.Body3 color="darkGray">전체 동의</Text.Body3>
                    </label>
                ...
                <Block.FormInputSection margin="10px 0 0 0 ">
                    ...
                    <label htmlFor="termsAgreed">
                        <Text.Body3 margin="0 7px 0 0 " color="darkGray">
                            이용약관 동의 (필수)
                        </Text.Body3>
                ...
                <Button.FormButton disabled={!isEnter} onClick={handleGoToNextStep} margin="42px 0 16px 0 ">
